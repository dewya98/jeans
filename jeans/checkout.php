      ...
      <div class="content">
        ...
        <div class="itemlist">
          ...
          <tr>
            ...
            $id=$_SESSION["id"]; 
            include "conn.php";
            $sql="select item.img, checkout.o_no,
            orderdtl.o_no, orderdtl.c_no, orderdtl.i_no, orderdtl.name, orderdtl.qty, orderdtl.price, orderdtl.size, orderdtl.color
           from orderdtl 
            INNER JOIN item 
            on orderdtl.i_no=item.i_no 
            INNER JOIN checkout
            on orderdtl.o_no=checkout.o_no 
            where orderdtl.id='$id'";
          ...
          <img src="<?php echo $fname ?>"></td>
            ...
            <tr>
              <?php
                $sqlnet="select sum from checkout where id='$id'"; 
            ...
            <tr>
                <th>다른 곳으로 배송</th>
                <td><input type="text" name="newaddr" id="" size="50" placeholder="새주소입력"></td>
            </tr>
            <tr>
                <th>연락처</th>
            ...
            <tr>
                <th>결제방법</th>
               <td>무통장입금: 국민은행 123-1234-5678</td>
            </tr>                 
              <td colspan="8" align="center">
                  <input type="button" value="결제하기" onclick="order()"> 
                  <input type="button" value="구매취소" onclick="del(<?php echo $row["o_no"] ?>)">               
              </td>
            </tr>
         </table>
       </form>
