...
<content>
 ...
 <section>
 <div class="typing">
    <form enctype="multipart/form-data" name="ask" method="post" action="review_ok.php">
    <h4>제목:</h4>
      <div class="text">
         <input type="text" name="title"><input type="hidden" name="i_no" value="<?php echo $i_no ?>"> 
      </div> 
      <h4>내용</h4>
      <textarea placeholder="리뷰 작성하기" name="content"></textarea>
      <h4>이미지첨부</h4>
